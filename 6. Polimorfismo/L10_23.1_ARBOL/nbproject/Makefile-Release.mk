...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/l10_23.1_arbol.exe

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/l10_23.1_arbol.exe: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/l10_23.1_arbol ${OBJECTFILES} ${LDLIBSOPTIONS}
