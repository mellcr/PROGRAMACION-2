...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/22.1_l8_try.exe

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/22.1_l8_try.exe: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/22.1_l8_try ${OBJECTFILES} ${LDLIBSOPTIONS}
